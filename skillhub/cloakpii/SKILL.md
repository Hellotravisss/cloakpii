...
把一个文件夹里的个人信息(PII)脱敏、加密,并生成跨境合规材料 —— 一条命令。
开源工具,GitHub: https://github.com/Hellotravisss/cloakpii ,`pip install cloakpii`。
...
确认已安装:`cloakpii --version`。没有就提示用户 `pip install cloakpii`(需 Python ≥ 3.10)。
