...
class TestNewPIITypes:
    def test_mask_chinese_id(self):
        from cloakpii.pii import mask_chinese_id
    ...
    def test_mask_passport(self):
        from cloakpii.pii import mask_passport
    ...
    def test_mask_bank_account(self):
        from cloakpii.pii import mask_bank_account
...
class TestFileClassificationNew:
    def test_classify_xml(self):
        from cloakpii.migrate import _classify_file
...
class TestCompliance:
    def test_list_profiles(self):
        from cloakpii.compliance import list_profiles
    ...
    def test_get_profile(self):
        from cloakpii.compliance import get_profile
    ...
    def test_validate_migration_pass(self):
        from cloakpii.compliance import get_profile, validate_migration
...
class TestIntegrity:
    def test_compute_sha256(self, tmp_path):
        from cloakpii.integrity import compute_sha256
        f = tmp_path / "test.txt"
    ...
    def test_generate_manifest(self, tmp_path):
        from cloakpii.integrity import generate_manifest
        d = tmp_path / "data"
        d.mkdir()
    ...
    def test_write_and_verify_manifest(self, tmp_path):
        from cloakpii.integrity import write_manifest, verify_manifest
        d = tmp_path / "data"
        d.mkdir()
        (d / "a.txt").write_text("aaa")
        (d / "b.txt").write_text("bbb")
    ...
    def test_directory_hash(self, tmp_path):
        from cloakpii.integrity import compute_directory_hash
        d = tmp_path / "data"
        d.mkdir()
        (d / "a.txt").write_text("aaa")
...
class TestConfig:
    def test_default_config(self):
        from cloakpii.config import default_config
        c = default_config()
    ...
    def test_save_and_load_config(self, tmp_path):
        from cloakpii.config import default_config, save_config, load_config
        c = default_config()
        c.workers = 4
    ...
    def test_load_missing_raises(self, tmp_path):
        from cloakpii.config import load_config
...
class TestAudit:
    def test_log_and_read_entries(self, tmp_path):
        from cloakpii.audit import AuditLog, AuditEntry
    ...
    def test_log_migration_events(self, tmp_path):
        from cloakpii.audit import AuditLog
        log_path = tmp_path / "audit.jsonl"
        audit = AuditLog(log_path)
